...
$aksi="module/aksi_agenda.php";

switch($_GET[act]){
  // Tampil Agenda
  default:
    echo "<h2>Agenda</h2>
          <input type=button value='Tambah Agenda' onclick=\"window.location.href='?module=agenda&act=tambahagenda';\">
    ...
    while ($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td align=right width='40'>$no &nbsp;</td>
                <td>$r[tema]</td>
                <td width=110>$tgl_mulai</td>
                <td width=110>$tgl_selesai</td>
...
echo "<div class=\"pagination\"> $linkHalaman</div>";
  ...
  case "editagenda":
    ...
    echo "<h2>Edit Agenda</h2>
          ...
          combothn($thn_sekarang-2,$thn_sekarang+5,'thn_mulai',$get_thn);
    ...
    echo "</td></tr>
          ...
          combothn($thn_sekarang-2,$thn_sekarang+5,'thn_selesai',$get_thn2);
